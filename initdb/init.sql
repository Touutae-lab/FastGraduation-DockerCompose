...
CREATE USER `fastgrad_api`@`%` IDENTIFIED BY "376AD3B59CDFA305A42C9BE633C1BE41E124A3EF";
GRANT USAGE ON *.* TO `fastgrad_api`@`%`;
GRANT SELECT, INSERT, UPDATE, DELETE ON `fastgrad`.* TO `fastgrad_api`@`%`;


-- Privileges for `supertokens_users`@`%`
CREATE USER `supertokens_users`@`%` IDENTIFIED BY "8965A0FDC44B36238DD93C8EE509C323D3D26F25";
GRANT USAGE ON *.* TO `supertokens_users`@`%`;
