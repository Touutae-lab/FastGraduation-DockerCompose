...
--
-- Host: db:3306:3306
-- Generation Time: Sep 10, 2022 at 03:55 PM
...
--
-- Create a user for fastgrad backend system
--
CREATE USER "fastgrad_backend"@"%" IDENTIFIED BY "J&8!Z2Z^41z#%v3E";
GRANT SELECT, INSERT, UPDATE, DELETE ON fastgrad.* TO "fastgrad_backend"@"%";
...
INSERT INTO `course` (`id`, `name_th`, `name_en`, `credit`, `description_th`, `description_en`, `term_1`, `term_2`, `term_s`) VALUES
...
(13110, 'จิตวิทยากับชีวิตประจำวัน', 'Psychology and Daily Life', 3, 'จิตวิทยากับชีวิตประจำวัน ปัจจัยด้านลักษณะส่วนบุคคล ปัจจัยด้านสัมพันธภาพระหว่างบุคคล ปัจจัยด้านสังคม', 'Psychology and daily life. Individual factors. Interpersonal factors. Social factors.', 1, 1, 1),
(50100, 'การใช้ภาษาไทย', 'Usage of the Thai Language', 3, 'ศึกษาและฝึกทักษะการใช้ภาษาไทย', 'A study of the usage of the Thai Language and practice in writing.', 1, 1, 0),
...
(204494, 'หัวข้อเลือกสรรทางวิทยาการคอมพิวเตอร์ 1', 'Selected Topics in Computer Science 1', 3, 'เป็นการบรรยายในหัวข้อใหม่ต่างๆ ที่เป็นที่น่าสนใจในทางวิทยาการคอมพิวเตอร์', 'Lecture series are offered on topics of current interest in any area of computer science.', 1, 1, 0),
(204495, 'หัวข้อเลือกสรรทางวิทยาการคอมพิวเตอร์ 2', 'Selected Topics in Computer Science 2', 3, 'เป็นการบรรยายในหัวข้อใหม่ต่างๆ ที่เป็นที่น่าสนใจในทางวิทยาการคอมพิวเตอร์', 'Lecture series are offered on topic of current interest in any area of computer science.', 1, 1, 0),
...
(204779, 'หัวข้อพิเศษทางด้านวิทยาการคอมพิวเตอร์', 'SELECTED TOPICS IN COMPUTER SCIENCE', 2, 'การศึกษาหัวข้อที่น่าสนใจในปัจจุบัน และการพัฒนาใหม่ ๆ ในสาขาต่าง ๆ  ทางด้านวิทยาการคอมพิวเตอร์อย่างเข้ม', 'Intensive study of current interesting topics and new development in various fields of computer science.', 0, 0, 0),
(204789, 'หัวข้อพิเศษทางด้านวิทยาการคอมพิวเตอร์', 'SELECTED TOPICS IN COMPUTER SCIENCE', 3, 'การศึกษาหัวข้อที่น่าสนใจในปัจจุบัน และการพัฒนาใหม่ๆในสาขาต่างๆทางด้านวิทยาการคอมพิวเตอร์ อย่างเข้ม', 'Intensive study of current topics of  interest and new developments in various fields of computer science.', 0, 0, 0),
(206111, 'แคลคูลัส 1', 'Calculus 1', 3, 'อนุพันธ์และการประยุกต์ การหาปริพันธ์และการประยุกต์ สมการเชิงอนุพันธ์อันดับหนึ่งและการประยุกต์', 'Derivatives and applications, integration and applications, and first-order differential equations and some applications.', 1, 1, 0),
(206112, 'แคลคูลัส 2', 'Calculus 2', 3, 'สมการเชิงอนุพันธ์เชิงเส้นอันดับสอง ฟังก์ชันหลายตัวแปร ปริพันธ์หลายชั้น อนุกรมอนันต์', 'Linear second-order differential equations, functions of several variables, multiple integrals, and infinite series.', 0, 1, 1),
...
(206281, 'วิยุตคณิต', 'Discrete Mathematics', 3, 'ขั้นตอนวิธี ความสัมพันธ์ การอุปนัยและการเวียนเกิด การนับทั่วไป ทฤษฎีกราฟเบื้องต้น กราฟต้นไม้และข่ายงานพีชคณิตบูลีน', 'Algorithms, relations, induction and recursion, general counting, elementary graph theory, trees and networks, Boolean algebra.', 1, 1, 0),
...
(206336, 'การวิเคราะห์เชิงจริง 1', 'Real analysis 1', 3, 'จำนวนจริง ลำดับและอนุกรมของจำนวน ลิมิตและภาวะต่อเนื่องของฟังก์ชัน การหาอนุพันธ์ ปริพันธ์แบบรีมันน์', 'Real numbers, sequences and series of numbers, limits and continuity of functions, differentiation, Riemann integral.', 1, 1, 0),
...
(206370, 'ความน่าจะเป็น 1', 'Probability 1', 3, 'รากฐานของความน่าจะเป็น ความน่าจะเป็นมีเงื่อนไข ตัวแปรสุ่ม ค่าคาดหวังและโมเมนต์ของตัวแปรสุ่ม การประมาณตัวแปรสุ่ม', 'Foundation of probability, conditional probability, random variables, expectation and moment of random variables, approximation of random variables.', 1, 1, 0),
...
(206428, 'ทฤษฎีรหัส', 'Coding Theory', 3, 'บทนำสู่ทฤษฎีรหัส รหัสเชิงเส้น ขอบเขตของรหัสและรหัส รหัสพหุนาม', 'Introduction to coding theory, linear codes, bounds in coding theory and codes, polynomial codes.', 1, 1, 0),
...
(206467, 'ข่ายงานประสาท', 'Neural Networks', 3, 'บทนำสำหรับข่ายงานและการเรียนรู้ของเครื่อง เพอร์เซปตรอน ข่ายงานป้อนไปข้างหน้า ข่ายงานแบบวนซ้ำ', 'Introduction to neural networks and machine learning, perceptron, feed-forward networks, recurrent networks.', 1, 1, 0),
...
(206481, 'ทฤษฎีกราฟ', 'Graph Theory', 3, 'บทนำ ทฤษฎีกราฟมูลฐาน กราฟต้นไม้ กราฟแบบออยเลอร์และกราฟแบบแฮมิลตัน กราฟเชิงระนาบ การให้สีกราฟ', 'Introduction, elementary graph theory, trees, Eulerian and Hamiltonian graphs, planar graphs and graph colorings.', 1, 1, 0),
...
(208101, 'สถิติสำหรับการดำรงชีวิตและการทำงาน', 'Statistics for Everyday Life and Work', 3, 'สถิติกับการดำรงชีวิตและการทำงาน สถิติและสารสนเทศกับการแก้ปัญหา การอธิบายเหตุและผลของปรากฏการณ์ต่างๆ การจัดทำข้อสรุปข้อมูล โอกาสและความไม่แน่นอน จากตัวอย่างไปสู่ประชากร การทดสอบสมมุติฐาน การสำรวจด้วยตัวอย่าง การพล็อตจุดและเส้น การประยุกต์ใช้ข้อสรุปทางสถิติ', 'Statistics for everyday life and work, statistics and information in problem solving, explaining causes and outcomes of phenomena, data summarization, chance and uncertainty, from sample to population, hypothesis testing, sample survey, plotting points and lines, applications of statistical conclusion.', 1, 1, 1),
...
(999001, 'วิชาเลือกเสรี', 'Free Elective Course', 1, 'บางวิชาที่ใช้ลงแค่ 1 หน่วยกิตเช่นตัวกีฬา', 'Some course that required just 1 degree for example about Physical Education', 0, 0, 0),
(999002, 'วิชาเลือกเสรี', 'Free Elective Course', 2, 'บางวิชาที่ใช้ลงแค่ 2 หน่วยกิต', 'Some course that required just 2 degrees', 0, 0, 0),
(999003, 'วิชาเลือกเสรี', 'Free Elective Course', 1, 'ตัววิชาที่อาจจะเหลือมาจาก GE หรือว่าลงเพิ่มเกิน', 'Some course that left from General Elective or Free Elective', 0, 0, 0),
(999005, 'วิชาโท', 'Minor Course', 1, 'วิชาโทที่ 1 หน่วยกิต', 'Some course that required just 1 degree', 0, 0, 0),
(999006, 'วิชาโท', 'Minor Course', 2, 'วิชาโทที่ 2 หน่วยกิต', 'Some course that required just 2 degree', 0, 0, 0),
(999007, 'วิชาโท', 'Minor Course', 3, 'วิชาโทที่สามหน่วยกิตหรือที่เกินมาจากตัวรหัส 300 , 400', 'Some course that required just 3 degree or left from Major course', 0, 0, 0);
...
(630510111, 1101, 3, 1, 2020, 'B', '3'),
(630510111, 1102, 3, 2, 2020, 'B', '3'),
(630510111, 1201, 3, 1, 2021, 'A', '4'),
(630510111, 13110, 1, 1, 2021, 'A', '4'),
(630510111, 140104, 3, 1, 2020, 'A', '4'),
(630510111, 201111, 3, 2, 2020, 'A', '4'),
(630510111, 202101, 3, 1, 2020, 'B', '3'),
(630510111, 202103, 3, 1, 2020, 'B', '3'),
(630510111, 203111, 3, 1, 2020, 'C', '2.5'),
(630510111, 203115, 3, 1, 2020, 'C+', '2.5'),
(630510111, 204100, 3, 2, 2020, 'B', '3'),
(630510111, 204111, 5, 1, 2020, 'B', '3'),
(630510111, 206111, 3, 2, 2021, 'A', '4'),
(630510111, 206281, 3, 1, 2021, 'C', '2'),
(630510111, 207117, 3, 2, 2020, 'B+', '3.5'),
(630510111, 207187, 3, 2, 2020, 'C+', '2.5'),
(630510111, 208263, 3, 1, 2021, 'B', '3'),
(640510112, 13110, 1, 1, 2021, 'A', '4'),
(640510112, 50100, 1, 1, 2021, 'A', '4'),
(640510112, 74100, 1, 1, 2021, 'A', '4'),
(640510112, 701181, 1, 1, 2021, 'A', '4'),
(640510112, 702101, 1, 1, 2021, 'A', '4');
...
('81cf6c85-2ecf-11ed-a0f7-0242ac130004', 630510111, 2020, 'fabe3701-2ecf-11ed-a0f7-0242ac130004'),
('00b40f07-2ed2-11ed-a0f7-0242ac130004', 640510112, 2020, 'fabe3701-2ecf-11ed-a0f7-0242ac130004');
...
('00b40f07-2ed2-11ed-a0f7-0242ac130004', 'student', 'studentY64@gmail.com', 'สอง', NULL, 'หกสี่', 'two', NULL, 'sixtwo'),
('81cf6c85-2ecf-11ed-a0f7-0242ac130004', 'student', 'studentY59@gmail.com', 'หนี่ง', NULL, 'ห้าเก้า', 'one', NULL, 'fifty-nine'),
('fabe3701-2ecf-11ed-a0f7-0242ac130004', 'advisor', 'advisor_one@gmail.com', 'แอดหนึ่ง', NULL, 'แอดทดลองหนึ่ง', 'adone', NULL, 'adtestone');
